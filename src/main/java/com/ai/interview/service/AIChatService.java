...
public class AIChatService {
	...
	// SSE error 事件用于在 HTTP 200 响应中传递业务错误。
	...
	public SseEmitter streamDeepAnalysis(Long userId, Long submitId) {
		...
		boolean isCorrect = Integer.valueOf(BusinessConstant.ANSWER_CORRECT).equals(submit.getIsCorrect());
